...
const Footer = () => {
  return (
    <div className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10 rounded-2xl">
      ...
      <div className="mb-6">
        ...
        <a
          ...
          className="text-base text-[#00a8ff] hover:text-blue-500 duration-300"
        >
          Email: BookCourier@gmail.com
        </a>
        <a
          href="tel:+880 123 456 789"
          className="text-base text-[#00a8ff] hover:text-blue-500 duration-300"
        >
          Mobile:+880 123 456 789
        </a>
