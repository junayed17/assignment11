...
const FormTitle = ({ heading, subHeading }) => {
  return (
    <div className="text-center my-4 px-2">
      
      {/* মেইন হেডিং */}
      <h2
            className="text-3xl md:text-4xl font-extrabold text-base-content mb-1 tracking-tight heading"
            data-aos="zoom-in"
          >
{heading.split(" ")[0]+" "}<span className="text-blue-600">{heading.split(" ")[1]+" "}</span>{heading.split(" ").splice(2).join(" ")}
          </h2>
      <div
        className="relative h-1.5 w-40 mx-auto mb-2 overflow-hidden bg-gray-200 dark:bg-gray-800 rounded-full"
        data-aos="fade-up"
      >
        <div
