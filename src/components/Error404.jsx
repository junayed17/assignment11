  ...
  return (
    <div className="flex items-center justify-center">
      <div className='text-center'>
        <img
          src="https://i.ibb.co.com/pjcH8wZx/Screenshot-2025-12-12-165929.png"
          alt=""
        />
        <Link
          class="relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group my-4 btn-circle w-[50%]"
          id="cancel"
          type="button"
          to="/"
        >
